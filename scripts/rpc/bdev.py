...
def bdev_photon_create(client, trid, nsid, num_blocks, ip, port, expiration, timeout):
    params = {'num_blocks': num_blocks, 'nsid': nsid, 'trid': trid, 'ip': ip, 'port': port, 'expiration': expiration, 'timeout': timeout}
