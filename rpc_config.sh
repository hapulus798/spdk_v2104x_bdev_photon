...
sudo scripts/rpc.py bdev_photon_create --trid "trtype:pcie traddr:0000:86:00.0" --nsid 1 --num_blocks 1024 --ip "127.0.0.1" --port 43548 --expiration 10000000 --timeout 1000000
