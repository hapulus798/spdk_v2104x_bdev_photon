...
# bs_values=(16k 32k 64k 128k)
# iodepth_values=(16 32 64 128)

# for iodepth in "${iodepth_values[@]}"; do
#     for bs in "${bs_values[@]}"; do
#         echo "Running fio with iodepth=$iodepth, bs=$bs"
#         LD_PRELOAD=/home/hongjingxuan.hjx/spdk/spdk_v21.04.x_test/build/fio/spdk_nvme $myfio $myfiocfg --bs=$bs --iodepth=$iodepth > ./fio_test_res2_write2/${iodepth}_${bs}.txt
#     done
# done

LD_PRELOAD=/home/hongjingxuan.hjx/spdk/spdk_v21.04.x_test/build/fio/spdk_nvme $myfio $myfiocfg --bs=4k --iodepth=128